...
class ActivityFeaturesTest(unittest.TestCase):
    ...
    def test_turns_per_km(self, load_stream_mock):
        load_stream_mock.return_value = pd.DataFrame(
            {'latlng': [[52.1, 5.3], [52.2, 5.4], [52.338, 5.5], [52.4, 5.4], [52.5, 5.3]]},
            index=[1, 2, 3, 4, 5])
        ...
        self.assertAlmostEqual(features_result.turns_per_km[0], 0.5, 2)
        self.assertAlmostEqual(features_result.turns_per_km[1], 0.25, 2)
